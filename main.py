"""version1_patrick_b — food, score, high score, sidebar."""
...
def main() -> None:
    pygame.init()
    pygame.display.set_caption("Snake+ v1b")
    ...
    while running:
        ...
        if state == C.STATE_MENU:
            ...
            renderer.draw(screen, state, score, high_score, snake, items, enemies, game_over=False)
        else:
            renderer.draw(screen, state, score, high_score, snake, items, enemies, game_over=True)
